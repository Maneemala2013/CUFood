...
import edu.cuhk.csci3310.cufood.adapter.RestaurantAdapter;
import edu.cuhk.csci3310.cufood.model.Restaurant;
import edu.cuhk.csci3310.cufood.util.RestaurantUtil;
import edu.cuhk.csci3310.cufood.viewmodel.MainActivityViewModel;
...
//        // Get a ref to the restaurants collection
...
//                break;
    ...
    public void onRestaurantSelected(DocumentSnapshot restaurant) {
        ...
        intent.putExtra(MainActivity.KEY_RESTAURANT_ID, restaurant.getId());
        intent.putExtra(MainActivity.KEY_USER_ID, customerId);
        startActivity(intent);
    }
